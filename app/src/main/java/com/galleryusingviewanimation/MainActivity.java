...
public class MainActivity extends AppCompatActivity implements ViewSwitcher.ViewFactory {
    ...
    protected void makeAnimations() {
        ...
        scale.setStartOffset(3100);
        scale.setDuration(3000);

        rotate = new RotateAnimation(0f, 360f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
        rotate.setInterpolator(new AccelerateDecelerateInterpolator());
        rotate.setStartOffset(3100);
        ...
        translate = new TranslateAnimation(0f, 0f, -600f, 0f);
        ...
        TranslateAnimation trans_in = new TranslateAnimation(0f, 0f, -1000f, 0f);
    ...
    private AdapterView.OnItemClickListener getGridViewOnItemClick_AnimVersion = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            mImgSwitcher.setImageResource(miImgArr[position]);
            Toast.makeText(MainActivity.this, String.valueOf(selection), Toast.LENGTH_SHORT).show();
        }
    };
}
